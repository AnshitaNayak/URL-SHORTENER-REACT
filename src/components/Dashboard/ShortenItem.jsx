...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
    ...
    // whenever there is an API call to backend then it will take some time inorder to load data from backend 
    // so till time data loads, we will show some alert/popup window which says data is loading....
    // for this purpose, we keep it's track using loader useState.
    ...
    // this method will be called when there is a change in "selectedUrl" 
    // for this, we will be using useEffect below
    ...
    // if there is any change in the selectedUrl then execute the arrow function which is fetchMyShortUrl in below useEffect.
    useEffect(() => {
        if (selectedUrl) {
            fetchMyShortUrl();
        }
